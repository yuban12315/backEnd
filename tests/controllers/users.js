...
// })
// let cookie
// cookie=[ 'connect.sid=s%3A18aYDgvG-O-iaQ-KY83vxbDpY6L0CXp-.OX5SEimQ9NQiVEH8vVZybCXswVgVzJAj9wBnaqn8MyI; Path=/; HttpOnly' ]async.waterfall([
//     //登录
//     (callback) => {
//         request.post(`${url}/login`, {
//             email: '455678228@qq.com',
...
request.post(`${url}/getVcode2`,{mailTo:'455678228@qq.com'}).end((error,res)=>{
    console.log(res.text)
})